<?php
	// Underscore and semi-colon missing in session_start() function below. Fixed the issue.
	session_start();
?>
<?php
	/*
	...
	*/
	...
	// backslash missing. Fixed the issue.
...
?>
		...
		<main id="pg-main-content">
			...
			<!-- The question mark is missing in php starter and the quotes are unmatched. Fixed the issue. -->
			<?php
				...
				<section class="space-above-below">
					...
					<?php
						if (isset($_GET['search-keywords'])) {
							...
							// Less than symbol type mark missing. Fixed the issue.
