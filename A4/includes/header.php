		...
		<header id="pg-header">
			<nav class="navbar navbar-expand navbar-dark bg-dark" aria-label="Second navbar example">
				<div class="container-fluid">
					...
					<?php 
						// Open parenthesis missing. Fixed the issue. 
						// Underscore missing in between $ and session. Fixed the issue.
					...
					<?php
						...
						// else statement is incorrect. Fixed the issue
						else {
					?>		
					<!-- Added registration navigation page in the menu -->
							<li class="nav-item active">
